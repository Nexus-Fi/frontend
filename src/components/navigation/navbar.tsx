...
const style = {
  ...
  headerItem: `block py-2 px-3 rounded md:p-0 md:hover:text-purple-900 text-black hover:bg-gray-700 hover:text-white md:hover:bg-transparent  md:hover:drop-shadow-2xl border-gray-700 cursor-pointer`,
