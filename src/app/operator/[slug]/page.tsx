      ...
      <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-4 bg-indigo-800 text-white rounded-md shadow-md">
            <div className="flex justify-between items-center">
              <span className="flex items-center space-x-2">
                <span className="bg-white text-indigo-900 rounded-full px-2 py-1">
                  EIGEN
                </span>
                <span>EIGEN</span>
              </span>
        ...
        <div>
          <div className="p-4 bg-indigo-800 text-white rounded-md shadow-md">
            ...
            <p>
              EigenDA is a data availability solution with 10 MiB/s of write
              throughput and the lowest cost in its class. The system&apos;s
              design is inspired by Danksharding, which promises to scale
              Ethereum&apos;s DA beyond EIP-4844. EigenDA is available today.
              Learn more at
              <a
                href="https://docs.eigenlayer.xyz/eigenda/overview/"
